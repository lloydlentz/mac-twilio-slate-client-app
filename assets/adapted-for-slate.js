...
$(function() {
  ...
  phoneNumber.value = getUrlParameter("number");
  var caller = getUrlParameter("caller")

  var device;

  log("Requesting Access Token...");
  // Using a relative link to access the Voice Token function
  $.getJSON("./voice-token?caller_id="+caller)
    .then(function(data) {
      log("Got a token.");
  ...
  function setClientNameUI(clientName) {
    ...
    div.innerHTML = "Your caller id: <strong>" + clientName + "</strong>";
  }
});
